...
<body>
    <div class="container">
        <h1>Xác nhận đặt lại mật khẩu tài khoản</h1>
        <p>Xin chào, chúc ngày mới tốt lành!</p>
        <p>Bạn nhận được email này vì yêu cầu đặt lại mật khẩu cho tài khoản của bạn.</p>
        <p>Hãy nhấp vào liên kết dưới đây để đặt lại mật khẩu:</p>
        <a href="{{ route('guest.customer.reset_password', ['email' => $customer->email, 'token' => $customer->token]) }}">Đặt lại mật khẩu</a>
