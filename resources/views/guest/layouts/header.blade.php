                ...
                <div class="col-xl-5 col-md-7 col-sm-6">
                    <div class="top-header-left">
                        <div class="shpping-order">
                            <h6>Giao hàng miễn phí cho đơn hàng trên 5 triệu đồng</h6>
                        </div>
                        <div class="app-link">
                            <h6>
                                Tải ứng dụng
                        ...
                        <div class="language-block">
                            ...
                            <div class="curroncy-dropdown">
                                <span class="curroncy-dropdown-click">
                                    VND<i class="fa fa-angle-down" aria-hidden="true"></i>
                                </span>
                        ...
                        <div class="nav-block">
                            ...
                            <div class="nav-left">
                                ...
                                <nav class="navbar" data-bs-toggle="collapse"
                                    ...
                                    <h5 class="mb-0  text-white title-font">Loại sản phẩm</h5>
                                </nav>
                        ...
                        <div class="menu-block">
                            <nav id="main-nav">
                                ...
                                <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                    <li>
                                        <div class="mobile-back text-right">Quay lại<i class="fa fa-angle-right ps-2"
                         ...
                         M451.001,482H451H61v-71.363C96.031,360.683,152.952,331,214.167,331h83.667c61.215,0,118.135,29.683,153.167,79.637V482z" />
                                ...
                                <li class="mobile-wishlist item-count" onclick="openWishlist()">
                                    <a href="javascript:void(0)">
                                        ...
                                        <div class="cart-item">
                                            <div>0 Sản phẩm<span>Yêu thích</span>
                                            </div>
                                        </div>
                                        <div class="item-count-contain">
                                            2
