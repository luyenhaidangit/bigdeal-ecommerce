                ...
                <div class="col-xl-7 col-md-5 col-sm-6">
                    <div class="top-header-right">
                        <div class="top-menu-block">
                            <ul>
                                <li><a href="javascript:void(0)">Quà tặng</a></li>
                                <li><a href="javascript:void(0)">Thông báo</a></li>
                                <li><a href="javascript:void(0)">Hỗ trợ</a></li>
                                <li><a href="javascript:void(0)">Ưu đãi hôm nay</a></li>
                         ...
                         M451.001,482H451H61v-71.363C96.031,360.683,152.952,331,214.167,331h83.667c61.215,0,118.135,29.683,153.167,79.637V482z" />
                                ...
                                <li class="mobile-wishlist item-count" onclick="openWishlist()">
                                    <a href="javascript:void(0)">
                                        ...
                                        <div class="cart-item">
                                            <div><span class="d-inline" id="count-wishlist">0</span> Sản phẩm<span>Yêu thích</span>
                                            </div>
                                        </div>
                                        <div class="item-count-contain item-count-contain-wishlist">
                                            2
                                        </div>
                                    </a>
                                </li>
                        ...
                        <div class="category-right">
                            <div class="contact-block">
                                <div>
                                    ...
                                    <span>Gọi chúng tôi<span>0922002360</span></span>
                                </div>
                            </div>
                            <div class="btn-group">
