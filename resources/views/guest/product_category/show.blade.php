                    ...
                    <div class="col-sm-3 collection-filter category-page-side">
                        ...
                        <div class="collection-filter-block creative-card creative-inner category-side">
                            ...
                            <div class="collection-collapse-block open">
                                <h3 class="collapse-block-title mt-0">Nhãn hiệu</h3>
                                        ...
                                        @foreach ($brands as $brand)
                                            <div
                                                ...
                                                <input type="checkbox"
                                                    ...
                                                    id="brand_{{ $brand->id }}" data-brand-id="{{ $brand->id }}"
                                                ...
                                                @foreach ($options['sizes']->take(5) as $size)
                                                    <div
                                                        ...
                                                        <input type="checkbox"
                                                            ...
                                                            id="{{ $size }}" onclick="handleSizeFilter()"
                                                            {{ in_array(urldecode($size), $selectedSizes) ? 'checked' : '' }}>
                                                        <label class="custom-control-label form-check-label"
                                                            for="{{ $size }}">
                                                            {{ $size }}
                                                        </label>
                                                ...
                                                @foreach ($options['rams']->take(5) as $ram)
                                                    <div
                                                        ...
                                                        <input type="checkbox"
                                                            ...
                                                            id="{{ $ram }}" onclick="handleRamFilter()"
                                                            {{ in_array(urldecode($ram), $selectedRams) ? 'checked' : '' }}>
                                                        <label class="custom-control-label form-check-label"
                                                            for="{{ $ram }}">
                                                            {{ $ram }}
                                                        </label>
                                                ...
                                                @foreach ($options['roms']->take(5) as $rom)
                                                    <div
                                                        ...
                                                        <input type="checkbox"
                                                            ...
                                                            id="{{ $rom }}" onclick="handleRomFilter()"
                                                            {{ in_array(urldecode($rom), $selectedRoms) ? 'checked' : '' }}>
                                                        <label class="custom-control-label form-check-label"
                                                            for="{{ $rom }}">
                                                            {{ $rom }}
                                                        </label>
                                                ...
                                                @foreach ($options['ram_roms']->take(5) as $ram_rom)
                                                    <div
                                                        ...
                                                        <input type="checkbox"
                                                            ...
                                                            id="{{ $ram_rom }}" onclick="handleRamRomFilter()"
                                                            {{ in_array(urldecode($ram_rom), $selectedRamRoms) ? 'checked' : '' }}>
                                                        <label class="custom-control-label form-check-label"
                                                            for="{{ $ram_rom }}">
                                                            {{ $ram_rom }}
                                                        </label>
                                                ...
                                                @foreach ($options['cpus']->take(5) as $cpu)
                                                    <div
                                                        ...
                                                        <input type="checkbox"
                                                            ...
                                                            id="{{ $cpu }}" onclick="handleCpuFilter()"
                                                            {{ in_array(urldecode($cpu), $selectedCpus) ? 'checked' : '' }}>
                                                        <label class="custom-control-label form-check-label"
                                                            for="{{ $cpu }}">
                                                            {{ $cpu }}
                                                        </label>
                                                ...
                                                @foreach ($options['sweep_frequencys']->take(5) as $frequency)
                                                    <div
                                                        ...
                                                        <input type="checkbox"
                                                            ...
                                                            id="{{ $frequency }}" onclick="handleFrequencyFilter()"
                                                            {{ in_array(urldecode($frequency), $selectedSweepFrequencys) ? 'checked' : '' }}>
                                                        <label class="custom-control-label form-check-label"
                                                            for="{{ $frequency }}">
                                                            {{ $frequency }}
                                                        </label>
                                                ...
                                                @foreach ($options['hard_drives']->take(5) as $hardDrive)
                                                    <div
                                                        ...
                                                        <input type="checkbox"
                                                            ...
                                                            id="{{ $hardDrive }}" onclick="handleHardDriveFilter()"
                                                            {{ in_array(urldecode($hardDrive), $selectedHardDrives) ? 'checked' : '' }}>
                                                        <label class="custom-control-label form-check-label"
                                                            for="{{ $hardDrive }}">
                                                            {{ $hardDrive }}
                                                        </label>
                                                ...
                                                @foreach ($options['resolutions']->take(5) as $resolution)
                                                    <div
                                                        ...
                                                        <input type="checkbox"
                                                            ...
                                                            id="{{ $resolution }}" onclick="handleResolutionFilter()"
                                                            {{ in_array(urldecode($resolution), $selectedResolutions) ? 'checked' : '' }}>
                                                        <label class="custom-control-label form-check-label"
                                                            for="{{ $resolution }}">
                                                            {{ $resolution }}
                                                        </label>
                                                ...
                                                <div class="product-filter-content">
                                                    ...
                                                    <div class="product-page-per-view">
                                                        <select id="perPageSelect" onchange="handlePerPageChange()">
                                                            <option value="1" {{ $perPage == 10 ? 'selected' : '' }}>
                                                                10 sản phẩm mỗi trang</option>
                                                            <option value="2" {{ $perPage == 20 ? 'selected' : '' }}>
                                                                20 sản phẩm mỗi trang</option>
                                                            <option value="5" {{ $perPage == 50 ? 'selected' : '' }}>
