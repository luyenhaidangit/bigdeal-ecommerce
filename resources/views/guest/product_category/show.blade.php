                ...
                <div class="row">
                    <div class="col-sm-3 collection-filter category-page-side">
                        ...
                        <div class="collection-filter-block creative-card creative-inner category-side">
                            ...
                            @if (isset($options['colors']) && $options['colors']->count() > 0)
                                <div class="collection-collapse-block open">
                                    <h3 class="collapse-block-title">Màu sắc</h3>
                                    <div class="collection-collapse-block-content">
                                        <div class="size-selector">
                            ...
                            @if (isset($options['sizes']) && count($options['sizes']->filter()) > 0)
                                <div class="collection-collapse-block open">
                                    ...
                                    <div class="collection-collapse-block-content">
                                        <div class="size-selector">
                                            <div class="collection-brand-filter">
                                                @foreach ($options['sizes']->take(5) as $color)
                                                    <div
                                                        class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                        <input type="checkbox" class="custom-control-input form-check-input"
                                                            id="{{ $color }}">
                            ...
                            @if (isset($options['rams']) && count($options['rams']->filter()) > 0)
                                <div class="collection-collapse-block open">
                                    ...
                                    <div class="collection-collapse-block-content">
                                        <div class="size-selector">
                                            <div class="collection-brand-filter">
                                                @foreach ($options['rams']->take(5) as $color)
                                                    <div
                                                        class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                        <input type="checkbox" class="custom-control-input form-check-input"
                                                            id="{{ $color }}">
                            ...
                            @if (isset($options['roms']) && count($options['roms']->filter()) > 0)
                                <div class="collection-collapse-block open">
                                    ...
                                    <div class="collection-collapse-block-content">
                                        <div class="size-selector">
                                            <div class="collection-brand-filter">
                                                @foreach ($options['roms']->take(5) as $color)
                                                    <div
                                                        class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                        <input type="checkbox" class="custom-control-input form-check-input"
                                                            id="{{ $color }}">
                            ...
                            @if (isset($options['ram_roms']) && count($options['ram_roms']->filter()) > 0)
                                <div class="collection-collapse-block open">
                                    ...
                                    <div class="collection-collapse-block-content">
                                        <div class="size-selector">
                                            <div class="collection-brand-filter">
                                                @foreach ($options['ram_roms']->take(5) as $color)
                                                    <div
                                                        class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                        <input type="checkbox" class="custom-control-input form-check-input"
                                                            id="{{ $color }}">
                            ...
                            @if (isset($options['cpus']) && count($options['cpus']->filter()) > 0)
                                <div class="collection-collapse-block open">
                                    ...
                                    <div class="collection-collapse-block-content">
                                        <div class="size-selector">
                                            <div class="collection-brand-filter">
                                                @foreach ($options['cpus']->take(5) as $color)
                                                    <div
                                                        class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                        <input type="checkbox" class="custom-control-input form-check-input"
                                                            id="{{ $color }}">
                            ...
                            @if (isset($options['sweep_frequencys']) && count($options['sweep_frequencys']->filter()) > 0)
                                <div class="collection-collapse-block open">
                                    <h3 class="collapse-block-title">Tần số</h3>
                                    <div class="collection-collapse-block-content">
                                        <div class="size-selector">
                                            <div class="collection-brand-filter">
                                                @foreach ($options['sweep_frequencys']->take(5) as $color)
                                                    <div
                                                        class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                        <input type="checkbox"
                            ...
                            @if (isset($options['hard_drives']) && count($options['hard_drives']->filter()) > 0)
                                <div class="collection-collapse-block open">
                                    <h3 class="collapse-block-title">Ổ cứng</h3>
                                    <div class="collection-collapse-block-content">
                                        <div class="size-selector">
                                            <div class="collection-brand-filter">
                                                @foreach ($options['hard_drives']->take(5) as $color)
                                                    <div
                                                        class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                        <input type="checkbox"
                                                            class="custom-control-input form-check-input"
                            ...
                            @if (isset($options['resolutions']) && count($options['resolutions']->filter()) > 0)
                                <div class="collection-collapse-block open">
                                    <h3 class="collapse-block-title">Độ phân giải</h3>
                                    <div class="collection-collapse-block-content">
                                        <div class="size-selector">
                                            <div class="collection-brand-filter">
                                                @foreach ($options['resolutions']->take(5) as $color)
                                                    <div
                                                        class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                        <input type="checkbox"
                                                            class="custom-control-input form-check-input"
